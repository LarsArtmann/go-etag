...
| Old TODO #1 (push cqrs-htmx's 7 alignment commits) verified **DONE**: origin/master already pins go-etag v0.3.1, httputil v1.2.0, server_timing v1.0.1; only 4 *unrelated* commits remain unpushed | `git show origin/master:go.mod`, `git log origin/master..HEAD` in cqrs-htmx                   |
