...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~Module layout~~ | ~~**One go.mod**: root shim + `server/` + `client/`~~ superseded 2026-09-23 — the module split made it five modules (`docs/modularization/2026-09-23_modularization-proposal.html`); the "zero shared code" premise fell to the entitytag extraction + metrics move-in | ~~Zero shared code between sides justifies no extra modules; one release track; no proxy-poisoning risk from path-scoped tags.~~ |
...
| 12 | _(Gated on user GO)_ Release v0.2.0 per go-release skill: CHANGELOG cut, tag, push, pkg.go.dev verify                                                                                                                                                                                                                          | 8      | 3      | 30        | Tag/proxy mistakes                  |
...
| 40 | `git push`                                                                                                                                                                      | E     | 2         |
| 41 | _(Gated)_ v0.2.0 release: CHANGELOG cut, annotated tag, push, proxy + pkg.go.dev + `go get` verify                                                                              | F     | 12        |
