...
func TestNew_GeneratesStrongETag(t *testing.T) {
	t.Parallel()
...
func TestNew_GeneratesWeakETag(t *testing.T) {
	t.Parallel()

	cfg := ETagConfig{Strength: Weak}
	handler := New(cfg)(newWriteStatusHandler(http.StatusOK, "hello world"))
...
func TestNew_EmptyBody(t *testing.T) {
	...
	handler := New(DefaultETagConfig())(newWriteStatusHandler(http.StatusOK, ""))
...
func TestNew_NoIfNoneMatchHeader(t *testing.T) {
	t.Parallel()
...
func TestNew_IfNoneMatch_EscapedQuoteEndToEnd(t *testing.T) {
	t.Parallel()
...
func TestNew_NonGetHead(t *testing.T) {
	t.Parallel()
...
func TestNew_HeadRequest_GeneratesETag(t *testing.T) {
	t.Parallel()
...
// B2: HEAD responses MUST NOT include a message body (RFC 7230 §3.3).
...
func TestNew_HeadRequest_IfNoneMatch(t *testing.T) {
	t.Parallel()
...
func TestNew_201Created_IsCacheable(t *testing.T) {
	t.Parallel()

	handler := New(DefaultETagConfig())(newWriteStatusHandler(http.StatusCreated, "created"))
...
func TestNew_MemoryLimit_DisablesETag(t *testing.T) {
	...
	handler := New(cfg)(newWriteStatusHandler(http.StatusOK, "this body exceeds the limit"))
...
func TestNew_Overflow_IfNoneMatch(t *testing.T) {
	t.Parallel()
...
// B1: Zero-value ETagConfig must not cause unbounded buffering.
func TestNew_ZeroValueConfig_ClampsBufferSize(t *testing.T) {
	t.Parallel()
...
// B3: 304 Not Modified MUST NOT include Content-Length.
func TestNew_304_ExcludesContentLength(t *testing.T) {
	t.Parallel()
...
func TestNew_Flush(t *testing.T) {
	...
	handler := New(DefaultETagConfig())(newFlushHandler())
...
func TestNew_FlushAlreadyFlushed(t *testing.T) {
	t.Parallel()
...
func TestNew_Hijack_SetsFlushedMode(t *testing.T) {
	t.Parallel()
...
func TestNew_Hijack_NoETag(t *testing.T) {
	t.Parallel()

	handler := New(DefaultETagConfig())(http.HandlerFunc(func(rw http.ResponseWriter, _ *http.Request) {
...
func TestNew_SkipIfPresent_RespectsHandlerETag(t *testing.T) {
	t.Parallel()
...
func TestNew_SkipIfPresent_Allows304WithHandlerETag(t *testing.T) {
	t.Parallel()
...
func TestNew_SkipIfPresent_FallsBackWhenNoHandlerETag(t *testing.T) {
	t.Parallel()
...
func TestNew_SkipPredicate(t *testing.T) {
	...
	assertETagEmpty(t, rec, "when Skip returns true")
	assertBody(t, rec, "hello world")
}

func TestNew_SkipPredicate_False(t *testing.T) {
	t.Parallel()
...
func TestETagConfig_Validate_InvalidStrength(t *testing.T) {
	...
	cfg := ETagConfig{Strength: Strength(42)}
...
func TestNew_OverflowWriteError(t *testing.T) {
	t.Parallel()
...
func TestNew_CustomHashFunc(t *testing.T) {
	t.Parallel()
...
func BenchmarkETag(b *testing.B) {
	handler := New(DefaultETagConfig())(newWriteBodyHandler([]byte("hello world benchmark test data")))
...
func BenchmarkMatchesIfNoneMatch(b *testing.B) {
	...
	tag := NewETag("779a65e7023cd2e7", Strong)
